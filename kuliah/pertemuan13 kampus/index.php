...
//query tabel mahasiswa sesuai tabel pebcarian
    ...
    <div class="container">
      ...
      <form action="" method="get" class="mt-4">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="keyword" placeholder="Masukan Nama" autocomplete="off">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="align-middle">
              ...
              <a href="hapus.php?id=<?= $mhs["id"] ?>" class="btn badge bg-danger" onclick="return confirm('Yakin Akan Dihapus?')" >Hapus</a>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
